        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 md:p-8 border border-gray-200">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-2 sm:gap-3">
              {roles.map((role) => (
                <button
                  ...
                  className={`p-2 sm:p-3 md:p-4 rounded-lg sm:rounded-xl text-center transition-all duration-200 h-14 sm:h-16 md:h-20 border-2 flex items-center justify-center ${
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full py-3 sm:py-4 px-4 rounded-lg font-bold text-white transition-all duration-200 text-sm sm:text-base ${
                isLoading
          ...
          {/* Demo Credentials */}
          <div className="mt-4 sm:mt-6 p-3 sm:p-4 md:p-5 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg sm:rounded-xl border border-blue-100">
            <h4 className="text-xs sm:text-sm font-bold text-gray-800 mb-2 sm:mb-3 flex items-center gap-1 sm:gap-2">
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Demo Credentials
            </h4>
            <div className="text-xs text-gray-700 space-y-1 sm:space-y-1.5 font-mono">
              <div className="break-words"><strong className="text-red-600">Admin:</strong> admin@attendance.com / password123</div>
              <div className="break-words"><strong className="text-purple-600">Principal:</strong> principal@attendance.com / principal123</div>
              <div className="break-words"><strong className="text-blue-600">HOD:</strong> hod.cs@attendance.com / hod123</div>
              <div className="break-words"><strong className="text-green-600">Faculty:</strong> faculty.cs1@attendance.com / faculty123</div>
              <div className="break-words"><strong className="text-orange-600">Student:</strong> student.cs1@attendance.com / student123</div>
            </div>
          </div>
        </div>
      </div>
