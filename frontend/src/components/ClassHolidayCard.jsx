...
const ClassHolidayCard = ({ classData, compact = false }) => {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-purple-100 text-sm">
                {classData.batch} • {classData.section} • {classData.semester}
              </p>
            </div>
          </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  {holiday.scope === 'global' && (
                    <div className="mt-2 inline-flex items-center space-x-1 bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">
...
export default ClassHolidayCard;
